...
describe('route', ()=> {
  ...
  it('provides all possible payment routes based on wallet assets and decentralized exchange routes', async ()=>{
    ...
    expect(routes[1].exchangeRoutes[0].amountInMax).toEqual(WETHAmountInBN)
    expect(routes[1].exchangeRoutes[0].amountOut).toEqual(tokenAmountOutBN)
    ...
    expect(routes[1].exchangeRoutes[0].transaction.method).toEqual('swapETHForExactTokens')
    expect(routes[1].exchangeRoutes[0].transaction.params.amountOut).toEqual(tokenAmountOutBN)
    ...
    expect(routes[2].exchangeRoutes[0].amountInMax).toEqual(DAIAmountInBN)
    expect(routes[2].exchangeRoutes[0].amountOut).toEqual(tokenAmountOutBN)
    ...
    expect(routes[2].exchangeRoutes[0].transaction.method).toEqual('swapTokensForExactTokens')
    expect(routes[2].exchangeRoutes[0].transaction.params.amountOut).toEqual(tokenAmountOutBN)
