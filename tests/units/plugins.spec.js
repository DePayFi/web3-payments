...
describe('plugins', ()=> {
  ...
  it('exports the payment plugins', async ()=>{
    ...
    expect(plugins.ethereum.event.address).toEqual('0x6A12C2Cc8AF31f125484EB685F7c0bfcE280B919')
    ...
    expect(plugins.bsc.event.address).toEqual('0xf83f63ccf66dfd9ef285e58217352835c470c56c')
  })
})
