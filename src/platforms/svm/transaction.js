...
const routeRaydiumCpSwap = async({ paymentRoute, wSolSenderAccountKeypair, deadline }) =>{
...
const routeRaydiumCpSwapSolOut = async({ paymentRoute, wSolEscrowAccountKeypair, deadline }) =>{
...
const routeRaydiumCpTwoHopSwap = async({ paymentRoute, wSolSenderAccountKeypair, deadline }) =>{
...
const routeRaydiumCpTwoHopSwapSolOut = async({ paymentRoute, wSolEscrowAccountKeypair, deadline }) =>{
...
const routeRaydiumClSwap = async({ paymentRoute, wSolSenderAccountKeypair, deadline }) =>{
...
const routeRaydiumClSwapSolOut = async({ paymentRoute, wSolEscrowAccountKeypair, deadline }) =>{
...
const routeRaydiumClTwoHopSwap = async({ paymentRoute, wSolSenderAccountKeypair, deadline }) =>{
...
const routeRaydiumClTwoHopSwapSolOut = async({ paymentRoute, wSolEscrowAccountKeypair, deadline }) =>{
...
const payment = async({ paymentRoute, wSolSenderAccountKeypair, wSolEscrowAccountKeypair, deadline })=> {
  ...
  switch(paymentMethod){
    ...
    return await routeRaydiumCpSwap({ paymentRoute, wSolSenderAccountKeypair, deadline });

    case 'routeRaydiumCpSwapSolOut':
    return await routeRaydiumCpSwapSolOut({ paymentRoute, wSolEscrowAccountKeypair, deadline });

    case 'routeRaydiumCpTwoHopSwap':
    return await routeRaydiumCpTwoHopSwap({ paymentRoute, wSolSenderAccountKeypair, deadline });

    case 'routeRaydiumCpTwoHopSwapSolOut':
    return await routeRaydiumCpTwoHopSwapSolOut({ paymentRoute, wSolEscrowAccountKeypair, deadline });

    case 'routeRaydiumClSwap':
    return await routeRaydiumClSwap({ paymentRoute, wSolSenderAccountKeypair, deadline });

    case 'routeRaydiumClSwapSolOut':
    return await routeRaydiumClSwapSolOut({ paymentRoute, wSolEscrowAccountKeypair, deadline });

    case 'routeRaydiumClTwoHopSwap':
    return await routeRaydiumClTwoHopSwap({ paymentRoute, wSolSenderAccountKeypair, deadline });

    case 'routeRaydiumClTwoHopSwapSolOut':
    return await routeRaydiumClTwoHopSwapSolOut({ paymentRoute, wSolEscrowAccountKeypair, deadline });
