...
describe('routeTwoHopOrcaSwapSolOut', ()=> {
  ...
  it('routes a payment through a twoHopOrcaSwap', async ()=>{
    ...
    expect(transaction.instructions[6].keys[14]).toEqual({ pubkey: new PublicKey('A6FdY6RXuHbrZvpt5ucefwDHvm99Vog9VUi1BQRfCny6'), isSigner: false, isWritable: true })
    expect(transaction.instructions[6].keys[15]).toEqual({ pubkey: new PublicKey('5ziJFbeTMgNLmRJYks622QmYcezESqU7UQkVAKLeKmEu'), isSigner: false, isWritable: true })
  ...
  it('routes a payment through a twoHopOrcaSwapSolOut + fee', async ()=>{
    ...
    expect(transaction.instructions[7].keys[14]).toEqual({ pubkey: new PublicKey('A6FdY6RXuHbrZvpt5ucefwDHvm99Vog9VUi1BQRfCny6'), isSigner: false, isWritable: true })
    expect(transaction.instructions[7].keys[15]).toEqual({ pubkey: new PublicKey('5ziJFbeTMgNLmRJYks622QmYcezESqU7UQkVAKLeKmEu'), isSigner: false, isWritable: true })
  ...
  it('does not create additional required accounts if conditions are met', async()=>{
    ...
    expect(transaction.instructions[2].keys[14]).toEqual({ pubkey: new PublicKey('A6FdY6RXuHbrZvpt5ucefwDHvm99Vog9VUi1BQRfCny6'), isSigner: false, isWritable: true })
    expect(transaction.instructions[2].keys[15]).toEqual({ pubkey: new PublicKey('5ziJFbeTMgNLmRJYks622QmYcezESqU7UQkVAKLeKmEu'), isSigner: false, isWritable: true })
