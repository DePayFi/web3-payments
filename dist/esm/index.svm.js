...
async function remoteRouteToPaymentRoute({ remoteRoute, from, accept }) {
  const fromToken = new Token$1({ blockchain: remoteRoute['blockchain'], address: remoteRoute['fromToken'] });
  const toToken = remoteRoute['fromToken'] == remoteRoute['toToken'] ? fromToken : new Token$1({ blockchain: remoteRoute['blockchain'], address: remoteRoute['toToken'] });
