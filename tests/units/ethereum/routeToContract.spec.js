...
describe('route to contract as payment receiver', ()=> {
  ...
  it('constructs payment transaction in a way that allows to pay into a smart contract', async ()=>{
    ...
    expect(routes[0].transaction.params.amounts).toEqual(['20000000000000000000'])
