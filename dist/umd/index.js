(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('depay-crypto-wallets'), require('depay-decentralized-exchanges'), require('depay-blockchain-token')) :
  typeof define === 'function' && define.amd ? define(['exports', 'depay-crypto-wallets', 'depay-decentralized-exchanges', 'depay-blockchain-token'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.PaymentRouting = {}, global.CryptoWallets, global.Exchange, global.BlockchainToken));
}(this, (function (exports, depayCryptoWallets, depayDecentralizedExchanges, depayBlockchainToken) { 'use strict';
