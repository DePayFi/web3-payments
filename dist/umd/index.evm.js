(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@depay/web3-blockchains'), require('@depay/web3-assets-evm'), require('@depay/web3-exchanges-evm'), require('@depay/web3-tokens-evm'), require('ethers')) :
  typeof define === 'function' && define.amd ? define(['exports', '@depay/web3-blockchains', '@depay/web3-assets-evm', '@depay/web3-exchanges-evm', '@depay/web3-tokens-evm', 'ethers'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Web3Payments = {}, global.Web3Blockchains, global.Web3Assets, global.Web3Exchanges, global.Web3Tokens, global.ethers));
})(this, (function (exports, Blockchains, web3AssetsEvm, web3ExchangesEvm, web3TokensEvm, ethers) { 'use strict';
  ...
  let addRouteAmounts = (routes)=> {
    return routes.map((route)=>{
      if(route.directTransfer && !route.fee) {
        if(route.fromToken.address.toLowerCase() == Blockchains__default["default"][route.blockchain].currency.address.toLowerCase()) {
