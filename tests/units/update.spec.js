...
describe('update', ()=> {
  ...
  it('updates payment routes with intermediate results', async ()=>{
    ...
    mockDecimals({ provider: provider('ethereum'), blockchain: 'ethereum', api: Token.ethereum.ERC20, token: DEPAY, decimals: 18 })
    ...
    mockUniswapPair(provider('ethereum'), '0xEF8cD6Cb5c841A4f02986e8A8ab3cC545d1B8B6d', [DEPAY, WETH])
    mockUniswapPair(provider('ethereum'), '0xEF8cD6Cb5c841A4f02986e8A8ab3cC545d1B8B6d', [WETH, DEPAY])
    mockUniswapPair(provider('ethereum'), CONSTANTS.ethereum.ZERO, [DEPAY, DAI_ethereum])
    mockUniswapPair(provider('ethereum'), CONSTANTS.ethereum.ZERO, [DAI_ethereum, DEPAY])
    mockUniswapPair(provider('ethereum'), CONSTANTS.ethereum.ZERO, [DEPAY, USDT_ethereum])
    ...
    mockBalance({ provider: provider('ethereum'), blockchain: 'ethereum', api: Token.ethereum.ERC20, token: DEPAY, account: fromAddress, balance: '2000000000000000000000' })
    ...
    mockUniswapAmounts({ provider: provider('ethereum'), method: 'getAmountsIn', params: ['20000000000000000000', [DEPAY, WETH, USDT_ethereum]], amounts: ['20000000000000000000', WETH_DAI_ethereum_amountIn, USDT_ethereum_amount] })
    mockUniswapAmounts({ provider: provider('ethereum'), method: 'getAmountsIn', params: ['20000000000000000000', [DEPAY, WETH, DAI_ethereum]], amounts: ['20000000000000000000', WETH_DAI_ethereum_amountIn, DAI_ethereum_amount] })
    mockUniswapAmounts({ provider: provider('ethereum'), method: 'getAmountsIn', params: ['20000000', [DEPAY, WETH, USDT_ethereum]], amounts: ['20000000', WETH_DAI_ethereum_amountIn, USDT_ethereum_amount] })
    ...
    mockAllowance({ provider: provider('ethereum'), blockchain: 'ethereum', api: Token.ethereum.ERC20, token: DEPAY, account: fromAddress, spender: routers.ethereum.address, allowance: CONSTANTS.ethereum.MAXINT })

    mockAssets({ provider: provider('bsc'), blockchain: 'bsc', account: fromAddress, assets: [
      {
        "name": "Binance Coin",
        "symbol": "BNB",
    ...
    mockBalance({ provider: provider('bsc'), blockchain: 'bsc', api: Token.bsc.BEP20, token: DAI_bsc, account: fromAddress, balance: '0' })
    ...
    expect(currentRoutes[0].transaction.params.amounts[0]).toEqual(WBNB_USDT_bsc_amountIn.toString())
    ...
    expect(currentRoutes[0].fromAmount).toEqual(WBNB_USDT_bsc_amountIn.toString())
    ...
    expect(currentRoutes[1].transaction.params.amounts[0]).toEqual(BUSD_bsc_amountIn.toString())
    ...
    expect(currentRoutes[1].fromAmount).toEqual(BUSD_bsc_amountIn.toString())
    ...
    expect(currentRoutes[3].transaction.params.amounts[0]).toEqual(WETH_DAI_ethereum_amountIn.toString())
    ...
    expect(currentRoutes[3].fromAmount).toEqual(WETH_DAI_ethereum_amountIn.toString())
    ...
    expect(currentRoutes[4].transaction.params.amounts[0]).toEqual('20000000')
    ...
    expect(currentRoutes[4].fromAmount).toEqual('20000000')
