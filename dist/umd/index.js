(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('depay-web3-constants'), require('depay-web3-wallets'), require('depay-web3-exchanges'), require('depay-web3-transaction'), require('depay-web3-tokens')) :
  typeof define === 'function' && define.amd ? define(['exports', 'depay-web3-constants', 'depay-web3-wallets', 'depay-web3-exchanges', 'depay-web3-transaction', 'depay-web3-tokens'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Web3Payments = {}, global.Web3Constants, global.Web3Wallets, global.Web3Exchanges, global.Web3Transaction, global.Web3Tokens));
}(this, (function (exports, depayWeb3Constants, depayWeb3Wallets, depayWeb3Exchanges, depayWeb3Transaction, depayWeb3Tokens) { 'use strict';
